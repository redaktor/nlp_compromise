...
var main = { 
  ...
  VB: { 
  	...
  	// add the adverb to 'phrasal' as an array with just the first negate element like ['on']
		...
		*/
		[
			...
			{ uid: 92, en: 'rise' },
			{ uid: 93, en: 'run', meta: {phrasal: {en:[['away'], ['over'], 'down','into','out','through']}} },
			...
			{ en: 'try', meta: { noDoer:['en'], 'filler':['en'], phrasal:{en:[['in'], ['on']]}} },
			...
			{ en: 'reduce' },
			{ en: 'look', meta: {phrasal: {en:[['over'], ['up'], 'after','back','forward','into']}} },
			{ en: 'interact' },
			{ en: 'concern' },
			{ en: 'labor' },
			{ en: 'return' },
	...
	phrasalVerbs: { 
		...
		*/
		words: [
			{ en: 'fire', meta: {phrasal: {en: [['away'], 'up']}} },
			{ en: 'barge', meta: {phrasal: {en: [['in']]}} },
			{ en: 'bash', meta: {phrasal: {en: [['in']]}} },
			{ en: 'book', meta: {phrasal: {en: [['in']]}} },
			{ en: 'box', meta: {phrasal: {en: [['in']]}} },
			{ en: 'butt', meta: {phrasal: {en: [['in']]}} },
			{ en: 'cash', meta: {phrasal: {en: [['in']]}} },
			{ en: 'fence', meta: {phrasal: {en: [['in']]}} },
			{ en: 'opt', meta: {phrasal: {en: [['in']]}} },
			{ en: 'rain', meta: {phrasal: {en: [['in']]}} },
			{ en: 'wean', meta: {phrasal: {en: [['in']]}} },
			{ en: 'wheel', meta: {phrasal: {en: [['in']]}} },
			{ en: 'carve', meta: {phrasal: {en: [['in'], ['up']]}} },
			{ en: 'hand', meta: {phrasal: {en: [['in'], ['up']]}} },
			{ en: 'jack', meta: {phrasal: {en: [['in'], 'off']}} },
			{ en: 'log', meta: {phrasal: {en: [['in'], ['on']]}} },
			{ en: 'peel', meta: {phrasal: {en: [['in'], 'off']}} },
			{ en: 'sign', meta: {phrasal: {en: [['in'], 'up']}} },
			{ en: 'type', meta: {phrasal: {en: [['in'], 'up']}} },
			{ en: 'warm', meta: {phrasal: {en: [['in'], 'up']}} },
			{ en: 'power', meta: {phrasal: {en: [['on'], ['up']]}} },
			{ en: 'snap', meta: {phrasal: {en: [['on'], 'up']}} },
			{ en: 'square', meta: {phrasal: {en: [['up'], 'off']}} },
			{ en: 'wind', meta: {phrasal: {en: [['up']]}} },
			{ en: 'back', meta: {phrasal: {en: [['up']]}} },
			{ en: 'bottle', meta: {phrasal: {en: [['up']]}} },
			{ en: 'buckle', meta: {phrasal: {en: [['up']]}} },
			{ en: 'bundle', meta: {phrasal: {en: [['up']]}} },
			{ en: 'clean', meta: {phrasal: {en: [['up']]}} },
			{ en: 'flag', meta: {phrasal: {en: [['up']]}} },
			{ en: 'man', meta: {phrasal: {en: [['up']]}} },
			{ en: 'pin', meta: {phrasal: {en: [['up']]}} },
			{ en: 'pipe', meta: {phrasal: {en: [['up']]}} },
			{ en: 'plump', meta: {phrasal: {en: [['up']]}} },
			{ en: 'scrape', meta: {phrasal: {en: [['up']]}} },
			{ en: 'slow', meta: {phrasal: {en: [['up']]}} },
			{ en: 'fool', meta: {phrasal: {en: ['about','around']}} },
			{ en: 'gad', meta: {phrasal: {en: ['about']}} },
			{ en: 'root', meta: {phrasal: {en: ['about','for','out']}} },
			{ en: 'boss', meta: {phrasal: {en: ['around']}} },
			{ en: 'horse', meta: {phrasal: {en: ['around']}} },
			{ en: 'joke', meta: {phrasal: {en: ['around']}} },
			{ en: 'mess', meta: {phrasal: {en: ['around','up']}} },
			{ en: 'back', meta: {phrasal: {en: ['away','out']}} },
			{ en: 'frighten', meta: {phrasal: {en: ['away','off']}} },
			{ en: 'tick', meta: {phrasal: {en: ['by','off']}} },
			{ en: 'zip', meta: {phrasal: {en: ['by','up']}} },
			{ en: 'bog', meta: {phrasal: {en: ['down']}} },
			...
			{ en: 'edge', meta: {phrasal: {en: ['out']}} },
			{ en: 'farm', meta: {phrasal: {en: ['out']}} },
			{ en: 'fish', meta: {phrasal: {en: ['out']}} },
			...
			{ en: 'tire', meta: {phrasal: {en: ['out']}} },
			{ en: 'trip', meta: {phrasal: {en: ['out','up']}} },
			{ en: 'trot', meta: {phrasal: {en: ['out']}} },
			{ en: 'weird', meta: {phrasal: {en: ['out']}} },
			{ en: 'whip', meta: {phrasal: {en: ['out','up']}} },
			{ en: 'wimp', meta: {phrasal: {en: ['out']}} },
			{ en: 'zone', meta: {phrasal: {en: ['out']}} },
			...
			{ en: 'gang', meta: {phrasal: {en: ['up']}} },
			{ en: 'gear', meta: {phrasal: {en: ['up']}} },
			{ en: 'hack', meta: {phrasal: {en: ['up']}} },
			...
			{ en: 'muddle', meta: {phrasal: {en: ['up']}} },
			{ en: 'open', meta: {phrasal: {en: ['up']}} },
			{ en: 'own', meta: {phrasal: {en: ['up']}} },
			{ en: 'patch', meta: {phrasal: {en: ['up']}} },
			...
			{ en: 'spark', meta: {phrasal: {en: ['up']}} },
			{ en: 'spruce', meta: {phrasal: {en: ['up']}} },
			{ en: 'stack', meta: {phrasal: {en: ['up']}} },
			{ en: 'stir', meta: {phrasal: {en: ['up']}} },
			{ en: 'stitch', meta: {phrasal: {en: ['up']}} },
			{ en: 'string', meta: {phrasal: {en: ['up']}} },
