...
var lexicon = (function() {
  ...
  ['nouns_inflect','nouns','verbs_special','verbs_conjugate','verbs','adjectives_decline','adjectives_demonym','adjectives','adverbs_decline','numbers','dates','honorifics','abbreviations','normalizations','multiples','posData','negateData','unambigousSuffixes'].forEach(reqDmodule);
  reqPmodules();
